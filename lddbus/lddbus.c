...
{
//	return !strncmp(dev->bus_id, driver->name, strlen(driver->name));//lpq del
	return 1;
}
...
//	strncpy(ldddev->dev.bus_id, ldddev->name, BUS_ID_SIZE);//lpq del
...
//	driver->version_attr.attr.owner = driver->module;//lpq del
